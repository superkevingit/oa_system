...
from message.views import OaMessageListView, OaMessageDetailView, new_oa_message, del_oa_message
...
#    url(r'^message/undo_del/(?P<pk>\d+)$', undo_del_oa_message, name='oa-message-del-undo'),
